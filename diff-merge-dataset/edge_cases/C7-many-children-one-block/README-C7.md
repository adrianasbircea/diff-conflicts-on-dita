# C7 - One block, 30+ changes inside it

**Priority:** high value
**Files:** `C7-base.dita` -> `C7-modified.dita`
**Change:** 26 of the 34 property lines in `c7-cb` change value; 8 are untouched.
...
**Fails if:** it prints a line-by-line list of all 26 changes, or truncates silently and describes
only the first few.
